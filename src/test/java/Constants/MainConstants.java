...
public class MainConstants {
    ...
    public static final String WANT_SOME_SCOOTER_ANSWER = "Пока что у нас так: один заказ — один самокат. " +
            "Если хотите покататься с друзьями, можете просто сделать несколько заказов — один за другим.";
    public static final String HOW_CALCULATE_RENT_TIME_QUESTION = "Как рассчитывается время аренды?";
    public static final String HOW_CALCULATE_RENT_TIME_ANSWER = "Допустим, вы оформляете заказ на 8 мая. " +
    ...
    public static final String GIVE_A_LIFT_ANSWER = "Самокат приезжает к вам с полной зарядкой. " +
    ...
    public static final String CAN_CANCEL_ORDER_ANSWER = "Да, пока самокат не привезли. Штрафа не будет, " +
